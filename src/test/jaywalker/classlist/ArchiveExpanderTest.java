...
public class ArchiveExpanderTest extends JayWalkerTestCase {
    ...
    public void testExpandMultiLevelJar() throws IOException, URISyntaxException {
        ...
        new ArchiveExpander().expand(new URL(URL_FILE_TEST4_JAR_PREFIX + "!/jaywalker-test3.jar"));
        new ArchiveExpander().expand(new URL(URL_FILE_TEST4_JAR_PREFIX + "!/jaywalker-test3.jar!/jaywalker-test1.jar"));
        assertTrue(cle.getEncodedFile().exists());
